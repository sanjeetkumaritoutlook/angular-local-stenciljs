...
import {
  ...
  formatDisplayNumberWithDecimal,
...
export const dublinTemplateConfig_ISO = [
  'expiry_date',
  'incept_date',
  'prior_and_pending_litigation_date_do',
  'run_off_effective_date',
  'run_off_start_date',
  'run_off_end_date',
  'additional_insured_effective_date',
  'prior_and_pending_litagation_date',
  'prior_and_pending_litigation_date_clubs_associations',
  'prior_and_pending_litigation_date_charities',
  'prior_and_pending_litigation_date_ptl',
];
export const premiumArrayDublin = [
  'additional_insured',
  'alternative_investment_fund_managers_directive_endorsement',
  'amendment_to_professional_services_exclusion',
  'aoc_limit',
  'co_insurance_agreement',
  'failure_to_maintain_insurance',
  'government_of_ireland_exclusion',
  'pi_exclusion_with_failure_to_supervise_carveback',
  'prior_and_pending_litigation_exclusion',
  'ptl_inclusion_of_cover_for_corporate_trustee',
  'retired_directors_extension',
  'retired_directors_extension',
  'ransomware_exclusion',
  'retroactive_date',
  'retroactive_date_endorsement',
  'ring_fenced_limits_endorsement',
  'run_off_endorsement',
  'social_engineering_exclusion',
  'specific_investment_products_exclusion',
  'specific_matters_exclusion',
  'subsidiary_company_extension',
  'tie_in_limits_endorsement',
];
export const dublinFICom_valueRoundoff = [
  'limit_of_liability_amount_do',
  'excess_amount_do_individual',
  'excess_amount_do_company_us_canada',
  'excess_amount_do_company_row',
  'non_executive_director_excess_limit_board',
  'acquisition_limit_do',
  'charity_reimbursement_limit',
  'charity_legal_liability_limit',
  'charity_employment_practices_limit',
  'charity_reimbursement_excess',
  'charity_legal_liability_excess',
  'charity_employment_practices_excess',
  'acquisition_limit',
  'excess_amount_us',
  'excess_amount_row',
  'erp_ap_rate',
  'ca_directors_officers_liability_limit',
  'ca_corporate_legal_liability_limit',
  'ca_employment_practices_liability_limit',
  'ca_directors_officers_excess',
  'ca_corporate_legal_excess',
  'ca_employment_practices_excess',
  'excess_amount_do_securities_row',
  'excess_side_a_limit_of_liability_amount',
  'non_executive_director_excess_limit_ind',
  'epl_liability_limit',
  'epl_usa_canada_excess',
  'epl_rest_of_world_excess',
  'limit_of_liability_amount_crime',
  'data_reproduction_expenses_sub_limit_crime',
  'excess_amount_crime',
  'excess_amount_crime_us_canada',
  'limit_non_ringfenced',
  'limit_ringfenced_1',
  'limit_ringfenced_2',
  'limit_ringfenced_4',
  'limit_ringfenced_5',
  'limit_ringfenced_3',
  'mitigation_costs_sublimit',
  'acquisition_limit_charities',
  'acquisition_limit_clubs_associations',
  'excess_amount_do_securities_us_canada',
  'acquisition_limit_epl',
  'ptl_liability_limit',
  'ptl_excess_amount_us',
  'ptl_excess_amt_row',
  'policyholder_acquisition_limit',
  'members_acquisition_limit',
  'civil_penalties_additional_premium',
  'civil_penalties_sub_limit_premium',
  'pollution_defence_costs_limit',
];
export const dublinTemplateConfig = (optionData) => ({
  //Dublin FI and Commercial TS
  //policy number: DUACJWD9002, DUABRL5G005, DU902187013,078771-013-PD,DUACN9NN002 ,DUABWLSJ005
  //DUAA5RAC008,DUABE29G008
  elements: [
    {
...

    {
      ...
      type: 'text',
      initialValue: optionData?.assured_name,
      validation: [
        {
          type: 'required',
...

    {
      ...
      rows: 4,
      type: 'text',
      initialValue: optionData?.assured_address_DU_excess,
      // assured_address_DU_excess
      validation: [
        {
          type: 'required',
...

    {
      ...
      elementType: 'input',
      type: 'text',
      initialValue: optionData?.broker,
      validation: [
        {
          type: 'required',
...

    {
      ...
      elementType: 'date',
      initialValue: optionData?.incept,
      validation: [
        {
          type: 'required',
...

    {
      ...
      elementType: 'date',
      initialValue: optionData?.marshDeltaExpiry,
      validation: [
        {
          type: 'required',
    ...
    //policy number:DUACN9NN002 enabled, but disabled in 078771-013-PD
    {
      ...
      elementType: 'input',
      type: 'text',
      initialValue: optionData?.tax_percent_10,
      ...
      dynamicConfig: () => {
        return {
          disabled: optionData.irish_tax_check === 0 ? true : false,
        };
      },
    },
    // Screen updated GRSAM-22973
    {
      ...
      elementType: 'input',
      type: 'text',
      initialValue: optionData?.totalipt_commercial1,
...

    {
      ...
      elementType: 'input',
      type: 'text',
      initialValue: String(optionData?.do_limit_cologne),
    ...
    },
    {
      ...
      elementType: 'input',
      type: 'text',
      initialValue: optionData?.fcc_limit_cologne,
      maskingConfig: {
        maskingFn: (value) => formatDisplayNumberOrDecimal(value),
        blurDelay: 500,
      },
...

    {
      ...
      initialValue: optionData?.prlOriginalCurrency,
      validation: [
        {
          type: 'required',
...

    {
      ...
      initialValue: String(optionData?.prlLimit),
      maskingConfig: {
        maskingFn: (value) => formatDisplayNumberOrDecimal(value),
        blurDelay: 500,
      },
...

    {
      ...
      elementType: 'input',
      type: 'text',
      initialValue: String(optionData?.prlLimit1),
      maskingConfig: {
        maskingFn: (value) =>
          !!value ? formatDisplayNumberOrDecimal(value) : null,
        blurDelay: 500,
...

    {
      ...
      elementType: 'input',
      type: 'text',
      initialValue: optionData?.do_original_currency_cologne,
    ...
    // },
    {
      ...
      //   //   type: 'minEntries',
      //   //   value: 1,
      //   //   message: `'At least one item must be added to the list'`
      //   // },
      //   {
      //     type: 'maxEntries',
      //     value: 5,
      //     message: `'Maximum 5 items only allowed.'`
      //   }
      // ],
      //  constraints: {
      //         minimumEntries: 2,
    ...
    //policy number- DUAA5RAC008  underscore in Opus wizard
    {
      ...
      elementType: 'input',
      initialValue: optionData?.dublinFIandCommercial_document_name,
      maskingConfig: {
...
export const premiumArrayTrimmed = [
  { dataPath: 'additional_insured', value: 'Additional Insured', order: 1 },
  {
    dataPath: 'alternative_investment_fund_managers_directive_endorsement',
    value: 'Alternative Investment Fund Managers Directive',
    order: 2,
  },
  {
    dataPath: 'amendment_to_professional_services_exclusion',
    value: 'Amendment to Professional Services Exclusion',
    order: 3,
  },
  { dataPath: 'aoc_limit', value: 'Any One Claim Limit', order: 4 },
  {
    dataPath:
      'cyber_risks_affirmation_endorsement_all_wordings_excl_crime_and_fi_pi',
    value: 'Cyber Risks Affirmation Endorsement',
    order: 5,
  },
  {
    dataPath: 'cyber_risks_affirmation_endorsement_crime',
  ...
  {
    dataPath: 'co_insurance_agreement',
    value: 'Co-Insurance Agreement',
    order: 6,
  },
  {
    dataPath: 'failure_to_maintain_insurance',
    value: 'Failure To Maintain Insurance/Reinsurance',
    order: 7,
  },
  {
    dataPath: 'government_of_ireland_exclusion',
    value: 'Government of Ireland Exclusion',
    order: 8,
  },
  {
    dataPath: 'payments_and_gratuities_endorsement',
    value: 'Payments and Gratuities Endorsement',
    order: 9,
  },
  {
    dataPath: 'pi_exclusion_with_failure_to_supervise_carveback',
    value:
      'Professional Indemnity Exclusion with Failure to Supervise Carveback',
    order: 10,
  },
  {
    dataPath: 'prior_and_pending_litigation_exclusion',
    value: 'Prior and Pending Litigation Exclusion',
    order: 11,
  },
  {
    dataPath: 'ptl_inclusion_of_cover_for_corporate_trustee',
    value: 'Inclusion of Cover for Corporate Trustee',
    order: 12,
  },
  {
    dataPath: 'ransomware_exclusion',
    value: 'Ransomware Exclusion',
    order: 13,
  },
  {
    dataPath: 'retired_directors_extension',
    value: 'Retired Directors Extension',
    order: 14,
  },
  {
    dataPath: 'retroactive_date_endorsement',
    value: 'Retroactive Date Endorsement',
    order: 15,
  },
  {
    dataPath: 'ring_fenced_limits_endorsement',
    value: 'Ring-Fenced Limits Endorsement',
    order: 16,
  },
  { dataPath: 'run_off_endorsement', value: 'Run Off Endorsement', order: 17 },
  {
    dataPath: 'social_engineering_exclusion',
    value: 'Social Engineering Exclusion',
    order: 18,
  },
  {
    dataPath: 'specific_investment_products_exclusion',
    value: 'Specific Investment Products Exclusion',
    order: 19,
  },
  {
    dataPath: 'specific_matters_exclusion',
    value: 'Specific Matters Exclusion',
    order: 20,
  },
  {
    dataPath: 'subsidiary_company_extension',
    value: 'Subsidiary Company Extension',
    order: 21,
  },
  {
    dataPath: 'territorial_exclusion_endorsement',
    value: 'Territorial Exclusion Endorsement',
    order: 21.1,
  },
  {
    dataPath: 'tie_in_limits_endorsement',
    value: 'Tie In Limits Endorsement',
    order: 22,
  },
];
